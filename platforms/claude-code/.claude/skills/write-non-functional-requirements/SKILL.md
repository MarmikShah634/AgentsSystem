...
inputs:
  - functional_requirements: "markdown of the Functional Requirements section"
outputs:
  - section: "markdown for the Non-Functional Requirements section, numbered NFR-1.. covering six required categories"
