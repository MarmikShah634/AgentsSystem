...
inputs:
  ...
  - rollback_ref: "release id or revision to restore (from deploy-environment output)"
  - reason: "1-2 sentence reason for the rollback (audit trail)"
  - approval_token: "required for prod; opaque token issued by human"
outputs:
  - restored_release_id: "id of the release that is now active"
  - prior_release_id: "id of the failing release being replaced"
  - tool_used: "kubectl|helm|terraform|ecs|gcloud|fly|..."
