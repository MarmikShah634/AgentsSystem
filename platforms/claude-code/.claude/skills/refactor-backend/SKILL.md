...
owner_agent: backend
inputs:
  - target_paths: "list of server-tier files to refactor"
  - refactor_goal: "concrete intent, e.g. extract repository, rename internal helper"
  - invariants: "behaviors that must not change (HTTP contract, DB schema, perf budget)"
outputs:
