---
id: gather-user-stories
category: requirements
owner_agent: requirements
inputs:
  - goal: "free-form goal string from the user or PM, may be a one-liner or a paragraph"
  - context_files: "list of absolute paths to supporting docs (existing PRDs, transcripts, notes)"
outputs:
  - user_stories: "ordered list of stories in canonical 'As a / I want / So that' form, one capability each"
  - open_questions: "list of ambiguities discovered while parsing the goal"
