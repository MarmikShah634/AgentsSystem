...
owner_agent: planner
inputs:
  - plan_steps: "DAG of plan steps with depends_on edges from decompose-task"
outputs:
  - ordered_steps: "topologically ordered plan_steps array, stable on ties"
  - rationale: "1-3 sentences citing critical path and parallel opportunities"
