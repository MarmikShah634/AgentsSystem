...
owner_agent: backend
inputs:
  - route: "HTTP path pattern, e.g. /v1/users/{id}"
  - method: "GET|POST|PUT|PATCH|DELETE"
  - request_schema: "JSON Schema for path + query + body"
  - response_schema: "{status_code: JSON Schema} per response"
  - tsd_section: "file path + anchor to the TSD's API contract"
outputs:
