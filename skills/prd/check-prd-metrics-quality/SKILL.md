---
id: check-prd-metrics-quality
category: prd
owner_agent: prd-reviewer
inputs:
  - prd_path: "absolute path to the PRD file under docs/prd/"
outputs:
  - findings: "list of {section, kind, msg, fix} entries, one per defective metric"
  - verdict: "'pass' if every metric has all four fields and a goal mapping else 'revise'"
