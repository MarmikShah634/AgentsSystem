...
inputs:
  - functional_requirements: "FRs from the PRD; each implies failure paths that must be enumerated"
outputs:
  - section: "Markdown for the TSD Error Model section; one row per error class"
