...
inputs:
  - user_stories: "list of stories from gather-user-stories"
  - acceptance_criteria: "list of ACs from extract-acceptance-criteria"
outputs:
  - validation_report: "{issues: [{story_id, ac_id?, kind, msg, fix}], verdict: 'pass'|'revise'}"
