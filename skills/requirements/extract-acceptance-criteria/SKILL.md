...
inputs:
  - user_stories: "list of {id, role, capability, value} from gather-user-stories"
outputs:
  - acceptance_criteria: "list of {story_id, ac_id, given, when, then} entries covering happy + edge paths"
