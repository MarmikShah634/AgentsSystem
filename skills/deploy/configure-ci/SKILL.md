...
owner_agent: devops
inputs:
  - ci_system: "github-actions|gitlab-ci|circleci|buildkite|jenkins"
  - jobs: "ordered list, subset of: install, lint, test, build, deploy"
  - language: "primary language for default tooling selection"
  - repo_root: "absolute path to repository root"
outputs:
  - ci_config_path: "path to authored/updated CI config file"
  - touched_paths: "list of modified files"
  - rationale: "1-3 sentence summary of changes"
