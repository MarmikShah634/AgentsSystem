...
inputs:
  - brand_context: "brand brief: tone, audience, references, brand keywords"
  - colour_strategy: "one value on the Restrained → Drenched scale: 'restrained' | 'balanced' | 'drenched'"
outputs:
  - palette: "{strategy, roles: {bg, fg, accent, muted, border} each as 9 OKLCH stops}"
  - rationale: "1-3 sentences justifying the strategy and accent choice"
