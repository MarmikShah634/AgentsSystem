...
inputs:
  - target_path: "absolute path to a component or page that contains interactive elements"
outputs:
  - findings: "array of {area, severity, path, line, component, missing_state, msg, fix}"
  - verdict: "'pass' | 'revise'"
