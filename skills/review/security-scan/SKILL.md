...
inputs:
  ...
  - repo_root: "absolute path to repository root for tool invocation"
  - language_hint: "optional: python|js|ts|go|java|ruby|rust"
outputs:
  - findings: "list of {severity, path, line, rule, msg, owasp}"
  - verdict: "pass | changes-requested | block"
  - tool_used: "semgrep|bandit|gosec|brakeman|checklist|..."
