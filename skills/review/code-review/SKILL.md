...
inputs:
  - patch: "unified diff of changes under review"
  - acceptance_criteria: "bulleted list from the plan step / TSD"
  - tsd_section: "optional file path + anchor for the relevant contract"
outputs:
  - findings: "list of {severity, path, line, msg}; severity ∈ critical|major|minor|nit"
  - verdict: "pass | changes-requested | block"
  - rationale: "1-3 sentence summary of overall assessment"
